...
<div class="flex flex-col justify-center items-center h-full w-full max-w-md mx-auto px-6">
  <div class="text-sm font-bold opacity-70 mb-2 text-center">Are you the spy? You can't know!</div>
  ...
  <form class="flex flex-col items-center w-full" onsubmit={(e) => { e.preventDefault(); submit_prompt(); }}>
    <label class="form-control w-full mb-6">
      <div class="label py-1">
        <span class="label-text font-bold text-sm text-base-content/80">Your Answer</span>
      </div>
      <input
        type="text"

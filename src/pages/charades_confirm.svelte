...
<div
  class="h-full overflow-y-auto mx-auto w-full flex flex-col justify-center items-center p-6"
>
  <div
    class="bg-linear-to-br from-purple-900/20 to-pink-900/20 rounded-3xl p-8 max-w-2xl h-fit w-full border-4 border-purple-500/30 shadow-2xl"
  >
    <div class="text-6xl mb-6">🎭</div>
    <h3 class="text-4xl font-bold mb-4 text-purple-300 text-center">
      Your Acting Prompt
    </h3>
    <div class="bg-black/40 rounded-2xl p-6 mb-6 border-2 border-purple-400/50">
      <div class="text-3xl font-bold text-yellow-300 text-center">
        {m_data.prompt}
      </div>
    </div>
    <div class="bg-red-900/30 rounded-xl p-6 mb-8 border-2 border-red-500/50">

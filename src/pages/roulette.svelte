<script lang="ts">
    ...
    const challenges: Record<string, string> = {
        ...
        "Reveal the first three digits of your Social Security Number": "SSN sneak peek",
    ...
    const m_data = get(player_state).pageData as RouletteData;
...
<div class="flex flex-col items-center mt-10">
    ...
    {/each}
    <button class="btn preset-filled-secondary-500 mt-8" on:click={placeBet}>Choose Challenge 🔥</button>
</div>

...
<div class="container h-full mx-auto w-full flex flex-col justify-center items-center">
    ...
    <form class="flex flex-col justify-center items-center w-full">
        ...
        />
        <button
            class="btn preset-filled-primary-500 text-lg font-bold text-white mt-12"

...
<div
  class="container overflow-y-auto h-full md:max-w-140 mx-auto w-full flex flex-col justify-start items-center"
>
  <form class="flex h-full flex-col justify-center items-center w-full">
    <div
      class="mb-12 px-10 py-3 text-lg text-white/85 text-center preset-filled-primary-300-700 rounded-2xl"
    >
      "{m_data.prompt}"
    </div>

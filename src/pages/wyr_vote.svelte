...
<div
  class="flex flex-col justify-center items-center h-full w-full max-w-md mx-auto px-6 py-6 text-center"
>
  <h2 class="text-3xl font-black mb-8">Would You Rather...</h2>
  ...
  <div class="w-full flex flex-col gap-4">
    ...
    <button
      type="button"
      class="btn btn-secondary btn-lg w-full py-5 h-auto text-lg font-black leading-snug"

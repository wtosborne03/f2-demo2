...
<div class="w-screen overflow-y-visible flex flex-col items-center p-0 m-0 sm:p-8 overflow-x-hidden">
    <div class="w-screen h-fit bg-white flex flex-col  sm:w-full sm:max-w-lg rounded-3xl sm:shadow-2xl">
        <div class="bg-linear-to-br from-[#ff6b6b] to-[#ff8e53] p-6 pb-4 text-center shadow-lg rounded-t-3xl shrink-0">
            <div class="text-3xl animate-pulse inline-block">💕</div>
            <h1 class="text-2xl font-extrabold text-white drop-shadow-md">Create Your Profile</h1>
        </div>

        <form class="p-6 flex-1 flex flex-col gap-4 h-fit" on:submit|preventDefault={submit_prompt}>
            <div class="w-full">
                <input
            ...
            <div class="w-full">
                <div class="flex items-center gap-4 bg-gray-50 border-2 border-gray-200 rounded-full px-5 transition-all focus-within:border-[#ff6b6b] focus-within:bg-white focus-within:ring-4 focus-within:ring-[#ff6b6b]/10 focus-within:scale-[1.02]">
                    <span class="font-semibold text-gray-500 text-base whitespace-nowrap">Age</span>
                    <input
            ...
            <div class="mt-2 flex flex-col items-center">
                <h2 class="text-xl font-bold text-gray-800 text-center mb-4">✨ Draw Your Portrait ✨</h2>

                <div class="w-full max-w-sm rounded-3xl overflow-hidden shadow-xl mb-4 bg-white border-4 border-gray-400">

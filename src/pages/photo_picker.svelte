<script lang="ts">
    ...
    $: (s_data, sendMessage({ type: "game", data: { type: "photo_picker", data: s_data } }));
...
<div class="container h-full mx-auto flex flex-col justify-center items-center text-2xl">
    ...
    <button type="button" class="btn preset-filled text-2xl" on:click={submit_answer}
        >Vote for Photo</button
    >
</div>

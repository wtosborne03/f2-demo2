...
// import GameClient from "./wsapi/old_client";
...
//   url: import.meta.env.VITE_PUBLIC_WS_API_URL,
//   role: "PLAYER",
//   autoReconnect: true,
//   autoRejoin: true,
...
//   const userId = session.get().data?.user.id ?? "";
//   gameClient.joinRoom(r_code, r_name, userId);
...
//       ...s,
//       ...state,
//       pageData: JSON.parse(state.pageDataJson || "{}"),
//     }));
//   } catch (error) {

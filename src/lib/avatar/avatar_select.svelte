    ...
    onMount(() => {
        ...
        r = new rive.Rive({
            ...
            onLoad: async () => {
                ...
                emote_fire_input = inputs.find(
                    (input) => input.name === "playEmote",
                );
                        ...
                        {#each Object.keys(owned_items) as category}
                            <section>
                                <div class="w-full flex items-center mb-4">
                                    ...
                                    <span
                                        class="flex-1 h-1 bg-slate-600 rounded"
                                    ></span>
                                </div>
                                ...
                                >
                                    {#each owned_items[category] || [] as item}
                                        ...
                                        >
                                            <div
                                                class="text-md leading-6 text-gray-200"
                                            >
                                                {item.shop.name}
                                            </div>
